...
async function main() {
  ...
  try {
    ...
    // // value는 모르겠음
    // let value = []; 
    // await sort_music_docs(clent, main_database, main_database_playlist, query, value);
...
async function sort_music_docs(client, dbname, colname, query, value) {
